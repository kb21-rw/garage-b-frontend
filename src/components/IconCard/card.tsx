...
const Card = ({ title, icon, description }: CardProps) => {
  return (
    <div className="flex flex-col h-full gap-5 xl:gap-10 dark:bg-black-300 bg-gray-300 border-l dark:border-primary border-gray-900 px-6 md:px-12 pb-6 md:pb-12 pt-3 min-h-100">
